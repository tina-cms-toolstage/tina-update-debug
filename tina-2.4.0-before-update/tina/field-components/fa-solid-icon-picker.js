import { faBan, faChevronRight, fas } from '@fortawesome/pro-solid-svg-icons'
...
/*
const IconOptions = {
  faChevronRight: (props) => <FontAwesomeIcon icon={faChevronRight} />,
  faBan: (props) => <FontAwesomeIcon icon={faBan} />,
}
*/
...
export const FaSolidIconPicker = wrapFieldsWithMeta(({ input }) => {
